    ...
    expect(
      classifyOpportunityForAutomation({
        ...
        evidenceQuality: {
          ...
          reasons: ['insufficient_independent_buyer_sources'],
          sourceQuality: {
            directPainCount: 1,
            duplicateContentCount: 0,
            genericAiWrapperCount: 0,
            genericSearchRefCount: 0,
            primaryBuyerSourceCount: 2,
            primaryDirectPainCount: 1,
            promoCount: 0,
            searchResultCount: 0,
            timeLossCount: 0,
            wtpOrBudgetCount: 0,
      ...
      classifyOpportunityForAutomation({
        ...
        evidenceQuality: {
          ...
          sourceQuality: {
            ...
            genericAiWrapperCount: 0,
            genericSearchRefCount: 0,
            primaryBuyerSourceCount: 3,
            primaryDirectPainCount: 3,
            promoCount: 0,
            searchResultCount: 0,
            timeLossCount: 1,
            wtpOrBudgetCount: 1,
